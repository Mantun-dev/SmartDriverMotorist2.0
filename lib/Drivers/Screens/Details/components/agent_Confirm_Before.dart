...
class DetailsAgentConfirmBefore extends StatefulWidget {
  final PlantillaDriver? plantillaDriver;

  const DetailsAgentConfirmBefore({Key? key, this.plantillaDriver}) : super(key: key);

  @override
  _DetailsAgentConfirmBeforeState createState() => _DetailsAgentConfirmBeforeState();
}

class _DetailsAgentConfirmBeforeState extends State<DetailsAgentConfirmBefore> {
