...
class DisponibilityAgent extends StatefulWidget {
  final PlantillaDriver? plantillaDriver;

  const DisponibilityAgent({Key? key, this.plantillaDriver}) : super(key: key);

  @override
  _DisponibilityAgentState createState() => _DisponibilityAgentState();
}

class _DisponibilityAgentState extends State<DisponibilityAgent> {
